...
public class SongController {
	...
	public @ResponseBody Map<String, Object> getSongById(@PathVariable("songId") String songId,
		...
		System.out.println("inside get song by id");
	...
	public @ResponseBody Map<String, Object> getSongTitleById(@PathVariable("songId") String songId,
		...
		System.out.println("inside get song title by id");
		Map<String, Object> response = new HashMap<String, Object>();
		response.put("path", String.format("GET %s", Utils.getUrl(request)));
	...
	public @ResponseBody Map<String, Object> deleteSongById(@PathVariable("songId") String songId,
		...
		System.out.println("inside get deleteSongById");
		Map<String, Object> response = new HashMap<String, Object>();
...
//		System.out.println(body);
		...
		if(params.containsKey("songName") && params.containsKey("songArtistFullName") && params.containsKey("songAlbum")) {
			System.out.println("no missing info");
...
//			System.out.println(dbQueryStatus.getData());
			...
			dbQueryStatus = new DbQueryStatus("Missing information", DbQueryExecResult.QUERY_ERROR_GENERIC);			
		}
		
		response = Utils.setResponseStatus(response, dbQueryStatus.getdbQueryExecResult(), dbQueryStatus.getData());
		System.out.println((response.toString()));
		
//		System.out.println("Inside add song");
		return response;
	}
